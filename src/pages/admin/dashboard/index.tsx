 ...
 const Dashboard = () => {
  ...
  return (
    <div>
      ...
      >
        <StatisticCard.Group direction={responsive ? 'column' : 'row'} className='mb-5'>
          <StatisticCard
            statistic={{
              title: 'Tổng đơn hàng',
              value: 601986875
          ...
          <StatisticCard
            statistic={{
              title: 'Đơn mua online',
              value: 3701928,
              description: <Statistic title='1 ngày' value='61.5%' />
            }}
          ...
          <StatisticCard
            statistic={{
              title: 'Đơn mua tại của hàng',
              value: 1806062,
              description: <Statistic title='1 ngày' value='38.5%' />
            }}
